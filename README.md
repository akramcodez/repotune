...
RepoTune is designed around a simple three-step workflow.
...
- Opt-In Telemetry: RepoTune collects anonymous usage data (like which commands are run) only if you explicitly opt in. No file contents, IP addresses, or personal information are ever tracked.

## Supported AI Providers

RepoTune supports a wide range of AI providers out of the box:
